<template>
    ...
    >
        ...
        <template v-else-if="iconName === 'text'">
            <path
        ...
        <template v-else-if="iconName === 'image'">
        ...
        <template v-else-if="iconName === 'zip'">
            <path
...
export default {
    ...
    setup(props) {
        const iconName = computed(() => {
            ...
            if (["text/css", "text/php", "text/javascript"].includes(mimeType))
                return "code";

            if (mimeType.substring(0, 5) === "image") return "image";
